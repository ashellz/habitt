          ...
          child: Column(
            ...
            children: [
              ...
              changelogContainer("v1.0.7",
                  "- Added ability to pause habits\n- Added a popup that appears when you add, edit or delete a habit\n- Added 300+ new icons\n- A prompt now shows up on launch if you are running an older version of the app\n- Notifications now match the selected language\n- Changed import current habits feature with add habits, which gives the user an option to select which habits to add to that day\n- Improved some design flaws\n- Improved logic when choosing the main category on home page\n- Minimal iOS version is now 15.6 (previously 13) due to back-end upgrades\n- Fixed bugs appearing when app is launched the first time ever\n- Fixed major bugs related to the last update"),
